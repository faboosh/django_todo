...
class TodoClient:
    ...
    TODO_LIST_URI = reverse('todo-lists')
    ...
    def do_put(self, uri, payload):
        return self.CLIENT.put(uri, payload, format='json')

    def do_patch(self, uri, payload):
        return self.CLIENT.patch(uri, payload, format='json')

    def do_get(self, uri):
        return self.CLIENT.get(uri, format='json')

    def do_delete(self, uri):
        return self.CLIENT.delete(uri, format='json')
